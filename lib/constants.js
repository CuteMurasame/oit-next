...
const TAIWAN_COMPETITION_CUTOFF = {
  "TOI海选": 0.55,     // 海选通过率相对较高，约40-50%通过
  "TOI初选": 0.65,     // 初选选出28-30人，晋级线较高
  "TOI选训营": 0.70,   // 选训营第一阶段，全员参与，为复选做准备
  "TOI复选": 0.75,     // 复选从28-30人筛到10-12人
  "TOI决选": 0.80,     // 决选从10-12人选出4人IOI国家队
  "IOI": 0.80          // IOI金牌线
};
...
const TAIWAN_DIFFICULTY_FACTORS = {
  "TOI海选": [1.0],
  "TOI初选": [0.5, 0.9, 1.3, 1.8],
  "TOI选训营": [0.7, 0.9, 1.2, 1.5, 1.7, 1.9],
  "TOI复选": [0.8, 1.0, 1.2, 1.4, 1.6, 1.8],
  "TOI决选": [0.9, 1.1, 1.3, 1.5, 1.7, 1.9, 2.0, 2.1],
  "IOI": [0.8, 0.8, 1.2, 1.5, 1.8, 2.2]
};
