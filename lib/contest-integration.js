...
(function(global){
  ...
  function generateInternationalStudents(chineseStudents){
      // 现存参赛国家/地区（中文）
      const countries = [
        '阿尔巴尼亚','阿尔及利亚','阿根廷','亚美尼亚','澳大利亚','奥地利','阿塞拜疆','孟加拉国','白俄罗斯','比利时',
        '玻利维亚','波斯尼亚和黑塞哥维那','巴西','保加利亚','加拿大','智利','中国','哥伦比亚','哥斯达黎加','克罗地亚',
        '古巴','塞浦路斯','捷克','丹麦','多米尼加','厄瓜多尔','埃及','萨尔瓦多','爱沙尼亚','芬兰','法国','加蓬',
        '格鲁吉亚','德国','加纳','希腊','洪都拉斯','中国香港','匈牙利','冰岛','印度','印度尼西亚','伊朗','爱尔兰',
        '以色列','意大利','日本','约旦','哈萨克斯坦','肯尼亚','科威特','吉尔吉斯斯坦','拉脱维亚','利比亚','立陶宛',
        '卢森堡','中国澳门','马达加斯加','马来西亚','马耳他','毛里求斯','墨西哥','摩尔多瓦','蒙古','黑山','摩洛哥',
        '莫桑比克','荷兰','新西兰','尼日利亚','北马其顿','挪威','巴基斯坦','巴勒斯坦','秘鲁','菲律宾','波兰',
        '葡萄牙','韩国','罗马尼亚','俄罗斯','卢旺达','沙特阿拉伯','塞尔维亚','新加坡','斯洛伐克','斯洛文尼亚',
        '南非','西班牙','斯里兰卡','瑞典','瑞士','叙利亚','中国台湾','塔吉克斯坦','泰国','特立尼达和多巴哥','突尼斯',
        '土耳其','土库曼斯坦','乌克兰','阿拉伯联合酋长国','英国','美国','乌兹别克斯坦','委内瑞拉','越南','津巴布韦'
      ];
      
      // 中文名称 -> 旗帜 emoji
      const countryFlagMap = {
        '阿尔巴尼亚':'🇦🇱','阿尔及利亚':'🇩🇿','阿根廷':'🇦🇷','亚美尼亚':'🇦🇲','澳大利亚':'🇦🇺','奥地利':'🇦🇹','阿塞拜疆':'🇦🇿',
        '孟加拉国':'🇧🇩','白俄罗斯':'🇧🇾','比利时':'🇧🇪','玻利维亚':'🇧🇴','波斯尼亚和黑塞哥维那':'🇧🇦','巴西':'🇧🇷','保加利亚':'🇧🇬',
        '加拿大':'🇨🇦','智利':'🇨🇱','中国':'🇨🇳','哥伦比亚':'🇨🇴','哥斯达黎加':'🇨🇷','克罗地亚':'🇭🇷','古巴':'🇨🇺','塞浦路斯':'🇨🇾',
        '捷克':'🇨🇿','丹麦':'🇩🇰','多米尼加':'🇩🇴','厄瓜多尔':'🇪🇨','埃及':'🇪🇬','萨尔瓦多':'🇸🇻','爱沙尼亚':'🇪🇪','芬兰':'🇫🇮',
        '法国':'🇫🇷','加蓬':'🇬🇦','格鲁吉亚':'🇬🇪','德国':'🇩🇪','加纳':'🇬🇭','希腊':'🇬🇷','洪都拉斯':'🇭🇳','中国香港':'🇭🇰',
        '匈牙利':'🇭🇺','冰岛':'🇮🇸','印度':'🇮🇳','印度尼西亚':'🇮🇩','伊朗':'🇮🇷','爱尔兰':'🇮🇪','以色列':'🇮🇱','意大利':'🇮🇹',
        '日本':'🇯🇵','约旦':'🇯🇴','哈萨克斯坦':'🇰🇿','肯尼亚':'🇰🇪','科威特':'🇰🇼','吉尔吉斯斯坦':'🇰🇬','拉脱维亚':'🇱🇻',
        '利比亚':'🇱🇾','立陶宛':'🇱🇹','卢森堡':'🇱🇺','中国澳门':'🇲🇴','马达加斯加':'🇲🇬','马来西亚':'🇲🇾','马耳他':'🇲🇹',
        '毛里求斯':'🇲🇺','墨西哥':'🇲🇽','摩尔多瓦':'🇲🇩','蒙古':'🇲🇳','黑山':'🇲🇪','摩洛哥':'🇲🇦','莫桑比克':'🇲🇿',
        '荷兰':'🇳🇱','新西兰':'🇳🇿','尼日利亚':'🇳🇬','北马其顿':'🇲🇰','挪威':'🇳🇴','巴基斯坦':'🇵🇰','巴勒斯坦':'🇵🇸',
        '秘鲁':'🇵🇪','菲律宾':'🇵🇭','波兰':'🇵🇱','葡萄牙':'🇵🇹','韩国':'🇰🇷','罗马尼亚':'🇷🇴','俄罗斯':'🇷🇺','卢旺达':'🇷🇼',
        '沙特阿拉伯':'🇸🇦','塞尔维亚':'🇷🇸','新加坡':'🇸🇬','斯洛伐克':'🇸🇰','斯洛文尼亚':'🇸🇮','南非':'🇿🇦','西班牙':'🇪🇸',
        '斯里兰卡':'🇱🇰','瑞典':'🇸🇪','瑞士':'🇨🇭','叙利亚':'🇸🇾','中国台湾':'🇨🇳','塔吉克斯坦':'🇹🇯','泰国':'🇹🇭',
        '特立尼达和多巴哥':'🇹🇹','突尼斯':'🇹🇳','土耳其':'🇹🇷','土库曼斯坦':'🇹🇲','乌克兰':'🇺🇦','阿拉伯联合酋长国':'🇦🇪',
        '英国':'🇬🇧','美国':'🇺🇸','乌兹别克斯坦':'🇺🇿','委内瑞拉':'🇻🇪','越南':'🇻🇳','津巴布韦':'🇿🇼'
      };
  ...
  /**
   * 为台湾IOI生成国际选手（包括中国大陆队）
   * @param {Array} taiwanStudents - 台湾队选手列表
   * @returns {Array} - 国际选手列表（包含中国大陆队）
   */
  function generateInternationalStudentsForTaiwan(taiwanStudents){
    // 首先生成普通国际选手（不包含中国）
    const internationalStudents = generateInternationalStudents(taiwanStudents);
    
    // 然后生成4个中国大陆队选手
    const mainlandCount = 4;
    const game = (typeof window !== 'undefined' && window.game) ? window.game : null;
    const gameDifficulty = (game && typeof game.difficulty === 'number') ? game.difficulty : 2;
    ...
    if(taiwanCount > 0){
      avgAbility = Math.round(avgAbility / taiwanCount);
      avgThinking = Math.round(avgThinking / taiwanCount);
      avgCoding = Math.round(avgCoding / taiwanCount);
      for(const k in knowledgeAvg) knowledgeAvg[k] = Math.round(knowledgeAvg[k] / taiwanCount);
    } else {
      avgAbility = avgThinking = avgCoding = 60;
      for(const k in knowledgeAvg) knowledgeAvg[k] = 60;
    }
    ...
    // 生成中国大陆队选手
    const mainlandNames = ['李华', '王明', '张伟', '刘强'];
    for(let i = 0; i < mainlandCount; i++){
      const abilityBase = avgAbility * (minRatio + Math.random() * (maxRatio - minRatio));
      const thinkingBase = avgThinking * (minRatio + Math.random() * (maxRatio - minRatio));
      const codingBase = avgCoding * (minRatio + Math.random() * (maxRatio - minRatio));
      
      const student = {
        name: `🇨🇳 中国队-${mainlandNames[i] || '选手' + (i+1)}`,
        ability: Math.round(abilityBase),
        thinking: Math.round(thinkingBase),
        coding: Math.round(codingBase),
        mental: Math.round(abilityBase),
        pressure: 20,
        comfort: 50,
        active: true,
        isInternational: true,
      ...
      // 添加知识点
      for(const k in knowledgeAvg){
        const val = knowledgeAvg[k] * (minRatio + Math.random() * (maxRatio - minRatio));
        if(k === '数据结构') student.knowledge_ds = Math.round(val);
        else if(k === '图论') student.knowledge_graph = Math.round(val);
        else if(k === '字符串') student.knowledge_string = Math.round(val);
        else if(k === '数学') student.knowledge_math = Math.round(val);
        else if(k === 'DP') student.knowledge_dp = Math.round(val);
      }
      ...
      student.getAbilityAvg = function(){ return (this.thinking + this.coding + this.mental)/3.0; };
      student.getKnowledgeTotal = function(){ return (this.knowledge_ds + this.knowledge_graph + this.knowledge_string + this.knowledge_math + this.knowledge_dp)/5.0; };
      student.getComprehensiveAbility = function(){
        const KNOWLEDGE_WEIGHT = 0.6, ABILITY_WEIGHT = 0.4;
      ...
      student.getKnowledgeByType = function(type){
      ...
      student.getMentalIndex = function(){
        const mentalBase = this.mental + (this._temp_modifiers.constmental || 0);
        let result = mentalBase - (this.pressure/100.0)*(1 - this.comfort/100.0);
        return Math.max(0, Math.min(100, result));
      };
      
      // 添加天赋
      if(typeof window.pickTalents === 'function'){
        const talents = window.pickTalents(talentCount, student);
        for(const t of talents) student.talents.add(t);
      }
    ...
    console.log(`[台湾IOI] 生成了${mainlandCount}个中国大陆队选手，总国际选手数: ${internationalStudents.length}`);
    return internationalStudents;
  }

  /**
   * 显示台湾IOI选拔模态框（当超过4人有资格时）
   * @param {Array} eligibleStudents - 有资格的学生列表
   * @param {Object} comp - 比赛对象
   * @param {Object} game - 游戏状态
   * @param {number} halfIndex - 当前赛季索引
   */
  function showTaiwanIOISelectionModal(eligibleStudents, comp, game, halfIndex){
    const modalRoot = document.getElementById('modal-root');
    if(!modalRoot) return;
    
    let html = `<div class="modal"><div class="dialog" style="max-width:700px;">`;
    html += `<h3>🏆 IOI代表队选拔</h3>`;
    html += `<p style="margin:15px 0;">共有 <strong>${eligibleStudents.length}</strong> 名学生通过TOI决选，但IOI最多只能派出 <strong>4</strong> 名选手代表中国台湾队参赛。</p>`;
    html += `<p style="margin:15px 0;color:#666;">请选择4名学生参加IOI：</p>`;
    
    // 按综合能力排序
    const sortedStudents = eligibleStudents.slice().sort((a, b) => {
      const aComp = (typeof a.getComprehensiveAbility === 'function') ? a.getComprehensiveAbility() : 0;
      const bComp = (typeof b.getComprehensiveAbility === 'function') ? b.getComprehensiveAbility() : 0;
      return bComp - aComp;
    });
    ...
    html += `<th style="padding:8px;text-align:center;width:60px;">选择</th>`;
    html += `<th style="padding:8px;text-align:left;">学生</th>`;
    html += `<th style="padding:8px;text-align:center;">综合能力</th>`;
    html += `<th style="padding:8px;text-align:center;">思维</th>`;
    html += `<th style="padding:8px;text-align:center;">代码</th>`;
    html += `</tr></thead><tbody>`;
    
    sortedStudents.forEach((s, idx) => {
      const comp = (typeof s.getComprehensiveAbility === 'function') ? s.getComprehensiveAbility().toFixed(1) : '0';
      const thinking = s.thinking || 0;
      const coding = s.coding || 0;
      const checked = idx < 4 ? 'checked' : ''; // 默认选中前4名
      html += `<tr style="border-bottom:1px solid #eee;">`;
      html += `<td style="padding:8px;text-align:center;"><input type="checkbox" class="taiwan-ioi-select" data-student-name="${s.name}" ${checked}></td>`;
      html += `<td style="padding:8px;"><strong>${s.name}</strong></td>`;
      html += `<td style="padding:8px;text-align:center;">${comp}</td>`;
      html += `<td style="padding:8px;text-align:center;">${thinking}</td>`;
      html += `<td style="padding:8px;text-align:center;">${coding}</td>`;
      html += `</tr>`;
    });
    
    html += `</tbody></table></div>`;
    html += `<div style="color:#ff9800;margin:10px 0;font-size:14px;" id="taiwan-ioi-warning"></div>`;
    html += `<button class="btn" id="taiwan-ioi-confirm">确认选择</button>`;
    html += `</div></div>`;
    
    modalRoot.innerHTML = html;
    
    // 添加事件监听
    const checkboxes = modalRoot.querySelectorAll('.taiwan-ioi-select');
    const warning = modalRoot.querySelector('#taiwan-ioi-warning');
    const confirmBtn = modalRoot.querySelector('#taiwan-ioi-confirm');
    
    checkboxes.forEach(cb => {
      cb.addEventListener('change', () => {
        const selected = modalRoot.querySelectorAll('.taiwan-ioi-select:checked').length;
        if(selected !== 4){
          warning.textContent = `请选择恰好4名学生（当前已选${selected}名）`;
    ...
    confirmBtn.addEventListener('click', () => {
      const selected = Array.from(modalRoot.querySelectorAll('.taiwan-ioi-select:checked'))
      ...
      // 过滤出选中的学生
      const selectedStudents = eligibleStudents.filter(s => selected.includes(s.name));
      
      console.log(`[台湾IOI] 用户选择了4名学生:`, selectedStudents.map(s => s.name));
      
      // 关闭模态框
      modalRoot.innerHTML = '';
      
      // 继续比赛流程，使用选中的学生
      continueTaiwanIOI(selectedStudents, comp, game, halfIndex);
    });
  }
   ...
   * 继续台湾IOI比赛（在用户选择后）
   */
  function continueTaiwanIOI(selectedStudents, comp, game, halfIndex){
    // 生成国际选手
    const internationalStudents = generateInternationalStudentsForTaiwan(selectedStudents);
    console.log(`[台湾IOI] 生成了 ${internationalStudents.length} 名国际选手（包含中国大陆队）`);
    
    // 为台湾队选手更名
    for(let s of selectedStudents){
      s.originalName = s.name;
      s.name = `🇨🇳 中国台湾队-${s.originalName}`;
    }
    ...
    // 合并参赛选手
    const allParticipants = [...selectedStudents, ...internationalStudents];
    
    // 运行比赛
    const results = window.CompetitionEngine.simulateCompetition(allParticipants, contestConfig);
    
    // 显示比赛UI
    if(typeof window.ContestUI !== 'undefined' && window.ContestUI.show){
      window.ContestUI.show(results, contestConfig, comp, (finalResults) => {
        // 比赛结束后的回调
        handleCompetitionResults(finalResults, contestConfig, comp);
      });
    }
  }
  ...
  const compOrder = isTaiwanProvince && typeof TAIWAN_COMPETITION_ORDER !== 'undefined' 
    ? window.TAIWAN_COMPETITION_ORDER 
    : (window.COMPETITION_ORDER || ["CSP-S1","CSP-S2","NOIP","省选","NOI"]);
  ...
  const halfIndex = (game.week > halfBoundary) ? 1 : 0;
    ...
    const isTaiwanIOI = comp.name === 'IOI' && comp.taiwanOnly && game.province_type === "台湾";
    const isMainlandIOI = comp.name === 'IOI' && comp.nationalTeam;
    ...
    if(isMainlandIOI){
      ...
      // 台湾IOI：需要选拔最多4人参赛，并生成国际选手
      console.log(`[台湾IOI] 有资格参赛的学生数: ${eligibleStudents.length}`);
      
      // 如果超过4人，需要用户选择
      if(eligibleStudents.length > 4){
        console.log(`[台湾IOI] 超过4人，需要用户选择参赛学生`);
        // 显示选择模态框，让用户选择4人
        showTaiwanIOISelectionModal(eligibleStudents, comp, game, halfIndex);
        return; // 等待用户选择后再继续
      }
      
      // 生成国际选手（包括中国大陆队）
      internationalStudents = generateInternationalStudentsForTaiwan(eligibleStudents);
      console.log(`[台湾IOI] 生成了 ${internationalStudents.length} 名国际选手（包含中国大陆队）`);
  ...
  function handleCompetitionResults(studentStates, config, originalComp, ineligibleStudents, internationalStudents){
    ...
    // IOI特殊处理：恢复中国队选手名字（大陆和台湾）
    const isTaiwanIOI = originalComp.name === 'IOI' && originalComp.taiwanOnly && game.province_type === "台湾";
    const isMainlandIOI = originalComp.name === 'IOI' && originalComp.nationalTeam;
    
    if(isMainlandIOI || isTaiwanIOI){
    ...
    const results = [];
      for(let state of studentStates){
        ...
        let passed = score >= passLine;

        // 先检查是否需要人格担保（在触发contest_finish事件之前）
        let shouldUsePersonalityGuarantee = false;
        if(typeof s.triggerTalents === 'function'){
          // 临时触发人格担保检查，但不正式触发contest_finish事件
          const talentResults = s.triggerTalents('contest_finish_precheck', {
          ...
          // 检查天赋结果，如果人格担保自动发动，则强制晋级
          for(const result of talentResults){
            if(result.result && result.result.action === 'personal_guarantee_auto_activated'){
              passed = true; // 强制晋级
              shouldUsePersonalityGuarantee = true;
              // 触发晋级状态更新事件
              s.triggerTalents('personal_guarantee_activated', {
                contestName: config.name,
                student: s
              });
              break;
        ...
        // 正式触发contest_finish事件（此时passed字段已经确定）
        if(typeof s.triggerTalents === 'function'){
    ...
    // IOI奖牌计算：按排名百分比分配奖牌（大陆和台湾均适用）
    if(originalComp && originalComp.name === 'IOI' && (originalComp.nationalTeam || isTaiwanIOI)){
      try{
        // 只对参赛选手计算奖牌（包括国际选手）
  ...
  const halfIndex = (game.week > halfBoundary_local) ? 1 : 0;
    ...
    // 统计晋级人数，包括通过人格担保天赋强制晋级的学生
    let passedCount = 0;
    let personalityGuaranteeUsed = false;
    
    for(let r of results){
      if(!r.notParticipated && r.passed){
        passedCount++;
        // 检查是否有学生是通过人格担保天赋强制晋级的
        if(r.student && r.student.talents && r.student.talents.has('已人格担保')){
          personalityGuaranteeUsed = true;
          console.log(`[人格担保统计] ${r.student.name} 通过人格担保天赋强制晋级`);
        }
      }
    }
    
    console.log(`[晋级统计] 比赛: ${originalComp.name}, 晋级人数: ${passedCount}, 人格担保使用: ${personalityGuaranteeUsed}`);
  ...
  function getCompetitionCutoff(compName, totalMax){
    ...
    // 台湾使用独立的晋级线配置
    if(provinceType === '台湾'){
      const taiwanCutoff = window.TAIWAN_COMPETITION_CUTOFF || TAIWAN_COMPETITION_CUTOFF;
      let basePercentage = taiwanCutoff[compName];
      
      console.log(`[台湾晋级线计算] 比赛: ${compName}, 总分: ${totalMax}`);
      console.log(`[台湾晋级线计算] basePercentage:`, basePercentage);
      
      if(typeof basePercentage !== 'number'){
        basePercentage = 0.70; // 台湾默认晋级线
        console.log(`[台湾晋级线计算] 使用默认值: ${basePercentage}`);
      }
      
      // 台湾比赛不应用浮动（选拔标准严格）
      const cutoffScore = Math.floor(totalMax * basePercentage);
      console.log(`[台湾晋级线计算] 最终分数线: ${cutoffScore} (${(basePercentage * 100).toFixed(1)}%)`);
      return cutoffScore;
    }
  ...
  function distributeRewards(results, compName){
    ...
    for(let r of results){
      ...
      } else if(compName === 'IOI' && r.medal){
        // IOI按奖牌等级发放奖励（适用于台湾模式）
        if(r.medal === 'gold'){
          reward = window.uniformInt ? 
            window.uniformInt(window.IOI_GOLD_REWARD_MIN || 80000, window.IOI_GOLD_REWARD_MAX || 120000) : 100000;
        } else if(r.medal === 'silver'){
          reward = window.uniformInt ? 
            window.uniformInt(window.IOI_SILVER_REWARD_MIN || 50000, window.IOI_SILVER_REWARD_MAX || 80000) : 65000;
        } else if(r.medal === 'bronze'){
          reward = window.uniformInt ? 
            window.uniformInt(window.IOI_BRONZE_REWARD_MIN || 30000, window.IOI_BRONZE_REWARD_MAX || 50000) : 40000;
        }
      } else if(compName === 'TOI决选'){
        // TOI决选：选拔出IOI国家队的比赛，给予高额奖励
        if(!r.passed) continue;
        reward = window.uniformInt ? 
          window.uniformInt(window.TOI_FINAL_REWARD_MIN || 50000, window.TOI_FINAL_REWARD_MAX || 80000) : 64000;
      } else if(compName === 'TOI复选'){
        // TOI复选：从28-30人选出10-12人
        if(!r.passed) continue;
        reward = window.uniformInt ? 
          window.uniformInt(window.TOI_RESELECTION_REWARD_MIN || 30000, window.TOI_RESELECTION_REWARD_MAX || 50000) : 40000;
      } else if(compName === 'TOI选训营'){
        // TOI选训营：选训营第一阶段
        if(!r.passed) continue;
        reward = window.uniformInt ? 
          window.uniformInt(window.TOI_TRAINING_REWARD_MIN || 16000, window.TOI_TRAINING_REWARD_MAX || 30000) : 22000;
      } else if(compName === 'TOI初选'){
        // TOI初选：从海选通过者中选出28-30人
        if(!r.passed) continue;
        reward = window.uniformInt ? 
          window.uniformInt(window.TOI_PRELIMINARY_REWARD_MIN || 8000, window.TOI_PRELIMINARY_REWARD_MAX || 16000) : 12000;
      } else if(compName === 'TOI海选'){
        // TOI海选：初赛，通过率较高
        if(!r.passed) continue;
        reward = window.uniformInt ? 
          window.uniformInt(window.TOI_SELECTION_REWARD_MIN || 2000, window.TOI_SELECTION_REWARD_MAX || 4000) : 3000;
      }
    ...
    try{
      if(typeof window.closeModal === 'function'){
        ...
        window.closeModal = function(){
          ...
          // 台湾专用：检查是否为IOI比赛结束，直接计算结果并结束游戏
          if(game.province_type === "台湾" && config && config.name === 'IOI'){
            try{
              console.log('[台湾IOI] IOI比赛结束，直接计算奖牌和结局');
              // 台湾直接进入IOI，不需要国家集训队流程
              // 计算IOI奖牌（基于总分的百分比）
              const ioiResults = results.filter(r => !r.notParticipated && !r.isInternational).map(r => {
                const percentage = r.score / (noiMaxScore || 600);
                let medal = null;
                const IOI_GOLD = typeof IOI_GOLD_THRESHOLD !== 'undefined' ? IOI_GOLD_THRESHOLD : 0.80;
                const IOI_SILVER = typeof IOI_SILVER_THRESHOLD !== 'undefined' ? IOI_SILVER_THRESHOLD : 0.65;
                const IOI_BRONZE = typeof IOI_BRONZE_THRESHOLD !== 'undefined' ? IOI_BRONZE_THRESHOLD : 0.20;
                
                if(percentage >= IOI_GOLD) medal = 'gold';
                else if(percentage >= IOI_SILVER) medal = 'silver';
                else if(percentage >= IOI_BRONZE) medal = 'bronze';
              ...
              // 统计奖牌数量
              const goldCount = ioiResults.filter(r => r.medal === 'gold').length;
              const silverCount = ioiResults.filter(r => r.medal === 'silver').length;
              const bronzeCount = ioiResults.filter(r => r.medal === 'bronze').length;
              
              // 保存到game状态
              game.taiwanIOIResults = ioiResults;
              
              // 根据奖牌数量决定结局
              console.log(`[台湾IOI] 奖牌统计 - 金:${goldCount} 银:${silverCount} 铜:${bronzeCount}`);
              let endingReason = '台湾IOI结束';
              
              if(goldCount >= 2){
                // 2金及以上：顶尖结局
                endingReason = '台湾IOI双金';
              } else if(goldCount >= 1){
                // 1金：优秀结局
                endingReason = '台湾IOI金牌';
              } else if(silverCount >= 2 || (silverCount >= 1 && bronzeCount >= 1)){
                // 多枚银牌或银铜组合：良好结局
                endingReason = '台湾IOI多牌';
              } else if(silverCount >= 1 || bronzeCount >= 1){
                // 至少1枚奖牌：普通结局
                endingReason = '台湾IOI奖牌';
              } else {
                // 无奖牌：遗憾结局
                endingReason = '台湾IOI无奖牌';
              }
              
              console.log(`[台湾IOI] 最终结局: ${endingReason}`);
              if(typeof window.triggerGameEnding === 'function'){
                window.triggerGameEnding(endingReason);
              }
            }catch(e){
              console.error('[台湾IOI] 计算结果失败', e);
            }
            return; // 不继续处理其他逻辑
          }
